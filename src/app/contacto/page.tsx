  ...
  return (
    <SiteShell site={site}>
      <section
        className={
          hasAside
            ? "mx-auto grid max-w-7xl gap-8 px-6 pb-20 pt-8 md:grid-cols-[1.1fr_0.9fr] md:gap-16 md:px-10 md:pb-24 md:pt-16"
            : "mx-auto max-w-3xl px-6 pb-20 pt-8 md:px-10 md:pb-24 md:pt-16"
        }
      >
        <div>
          <p className="kicker text-stone">{labels.conversemos}</p>
          <h1 className="display-sm mt-3 md:mt-4">{labels.contact}</h1>
